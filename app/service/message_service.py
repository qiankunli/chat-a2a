...
class MessageService:
    ...
    async def add_user(self, conversation_id: str, task_id: str, query: str) -> None:
    ...
    async def add_agent_query(self, conversation_id: str, task_id: str, query: str, from_agent: str) -> None:
        async with self.db.transaction() as session:
            user_message_do = MessageDO(conversation_id=conversation_id,
                                        task_id=task_id,
    ...
    async def add_agent_answer(self, conversation_id: str, task_id: str, answer: str, from_agent: str) -> None:
        async with self.db.transaction() as session:
            user_message_do = MessageDO(conversation_id=conversation_id,
                                        task_id=task_id,
                                        role=MessageRole.AGENT,
    ...
    async def add_agent_error(self, conversation_id: str, task_id: str, from_agent: str) -> None:
        async with self.db.transaction() as session:
            user_message_do = MessageDO(conversation_id=conversation_id,
                                        task_id=task_id,
                                        role=MessageRole.AGENT,
    ...
    async def add_agent_input_required(self, conversation_id: str, task_id: str, require_input: str,
                                       from_agent: str) -> None:
        async with self.db.transaction() as session:
            user_message_do = MessageDO(conversation_id=conversation_id,
                                        task_id=task_id,
    ...
    async def add_answer(self, conversation_id: str, task_id: str, answer: str) -> None:
        async with self.db.transaction() as session:
            user_message_do = MessageDO(conversation_id=conversation_id, task_id=task_id,
